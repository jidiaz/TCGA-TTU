...
comparisons <- read.csv(file="/Users/juansola/Desktop/directory_mapping.csv")
...
Humannet_library <- read.csv(file="/Users/juansola/Desktop/HumanNet-XC.tsv",sep = '\t', header=TRUE)  # para el jason
...
#Save the data used to create the nextorwk
